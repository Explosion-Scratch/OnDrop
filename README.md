...
See [`LICENSE.md`](https://github.com/Explosion-Scratch/ondrop/blob/master/LICENSE.md). (Basically you can use my code just so long as you give credit. _This is not legal advice. See LICENSE for full legal code._)
